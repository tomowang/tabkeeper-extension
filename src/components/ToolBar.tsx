...
export default function ToolBar({search, setSearch}: ToolBarProps) {
  return <Flex direction='row' alignItems='center' gap={2}>
    <Popover trigger="hover" placement="bottom-start">
      <PopoverTrigger>
        <Box><Icon as={IoMdHelpBuoy} w={6} h={6}></Icon></Box>
      </PopoverTrigger>
      <PopoverContent>
        <PopoverBody>
    ...
    <Box>
      <InputGroup size='sm'>
        ...
        <InputRightElement>
        { search &&
          <Icon as={RiCloseLine} w={6} h={6} cursor='pointer' onClick={() => setSearch('')}></Icon>
        }
        </InputRightElement>
      </InputGroup>
    </Box>
